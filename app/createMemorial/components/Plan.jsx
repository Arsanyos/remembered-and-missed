...
const PricingPlanComp = ({ curr }) => {
  ...
  return (
    <div
      style={{
        display: curr === 2 ? "block" : "none",
      }}
    >
      <div className="h-auto w-[100%] rounded-[25px] shadow-lg bg-[#FFFFFF] flex flex-wrap justify-center">
              ...
              {perks.map((item, index) => {
                return (
                  <div key={index} className="flex gap-4 ">
                    ...
                    />
                    <p
                      className="font-[Montserrat] font-normal text-[13px] text-[#FFFFFF] tracking-wide"
                      key={index}
                    >
                      {item}
                    </p>
