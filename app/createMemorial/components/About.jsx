...
const AboutComp = ({ curr, setErrors }) => {
  ...
  return (
    ...
    >
      <div>
        <p className=" text-[25px] text-[#5C5470] font-[Lora] font-normal tracking-[0.2px] leading-[45px]">
          This memorial is dedicated to:
        </p>
        <div className="flex flex-wrap justify-evenly gap-4 px-10 my-8">
          {formInputFields1.map((item, index) => {
            return (
              <div key={index} className="w-[30%] mt-[20px]">
                {item.type !== undefined ? (
                  item.type === "select" ? (
                    <div className="w-auto" key={index}>
                      ...
                      <div className="mt-2 rounded-md w-auto">
                        <select
                          ...
                          className=" w-full h-[46px] bg-[#DEE2E6] rounded-[25px] px-3"
                        >
                  ...
                  <div className="min-w-[30%] flex flex-col">
                    ...
                    <div
                      key={index}
                      className="flex gap-6 w-[50%] self-center mt-6"
                    >
                      {item.radio.map((item, index) => {
                        return (
                          <div
                            key={index}
                            className="flex gap-2 text-[16px] text-[#5C5470] font-normal"
                          >
                            <input
                              name="gender"
                              key={index}
                  ...
                  <div className="w-auto" key={index}>
                    ...
                    <div className="relative mt-2 rounded-md w-auto">
                      <input
                        ...
                        name={item.id}
                        id={item.id}
                        className="p-[0px 0px 0px 20.0463px] w-full text-[18px] h-[46px] bg-[#DEE2E6] rounded-[25px] px-5"
                      />
                    </div>
                  </div>
                )}
      ...
      <div>
        ...
        <div className="flex items-center justify-start ml-14 mt-8 gap-6 mt-2 rounded-md w-[80%]">
          <p className="text-[#5C5470] text-[20px] font-[Montserrat] font-normal leading-[18px]">
            https://
          </p>
          <input
            type="text"
            name="webAddress"
            id="webAddress"
            className="p-[0px 0px 0px 20.0463px] w-[30%] text-[18px] h-[46px] bg-[#DEE2E6] rounded-[25px] px-5"
          />
          <p className="text-[#5C5470] text-[20px] font-[Montserrat] font-normal leading-[18px]">
