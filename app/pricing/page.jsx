...
const Pricing = () => {
  ...
  return (
    <div className="flex flex-col h-auto">
      <div className="w-[100%] h-[40vh] bg-[#5C5470]"></div>
      <div className="z-999 relative bottom-[150px] left-[15.5%] h-auto py-20 w-[70%] rounded-[25px] shadow-lg bg-[#FFFFFF] flex justify-center">
        <div className="w-[50%] py-[95px] px-[50px] flex flex-col items-center justify-center">
        ...
        <div className="w-[50%] flex justify-center items-center">
          <div className="w-[90%] h-auto rounded-[25px] bg-[#5C5470] py-[40px] flex flex-col items-center justify-center gap-2">
            ...
            <div className="flex flex-col gap-4 mt-4 w-[55%]">
              ...
              <button className=" border-solid border-4 border-[#FFFFFF] bg-[#5C5470] shadow-customFigma rounded-[25px] drop-shadow-lg py-[20px] w-[223px] h-[52px] flex justify-center items-center text-[#FFFFFF]">
                GET STARTED
              </button>
            </div>
          </div>
